document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("addProductToCart").dataset.addToCart = product.id; const buy=document.getElementById("buyProductNow"); if(buy) buy.addEventListener("click",()=>{ window.DESHIGRAM_CART?.addToCart(product.id,1); window.location.href="checkout.html"; });
